...
export const defaultDrawerButtons: readonly ControlButton[] = [
	...
	},
	{
		id: 'codex-think−',
		label: 'Think−',
		description: 'Codex: less reasoning (Alt+,)',
	...
	},
	{
		id: 'codex-think+',
		label: 'Think+',
		description: 'Codex: more reasoning (Alt+.)',
		action: { type: 'send', data: '\x1b.' },
		section: 'Codex',
	},
	{
		id: 'codex-transcript',
		label: 'Transcript',
		description: 'Codex: open transcript (Ctrl+T)',
	...
	},
	{
		id: 'claude-mode',
		label: 'Mode',
		description: 'Claude Code: cycle mode (Shift+Tab)',
	...
	},
	{
		id: 'claude-verbose',
		label: 'Verbose',
		description: 'Claude Code: verbose output (Ctrl+O)',
		action: { type: 'send', data: '\x0f' },
		section: 'Claude',
	},
	{
		id: 'claude-tasks',
		label: 'Tasks',
		description: 'Claude Code: toggle tasks (Ctrl+T)',
		action: { type: 'send', data: '\x14' },
		section: 'Claude',
	},
	{
		id: 'claude-model',
		label: 'Model',
		description: 'Claude Code: switch model (Alt+P)',
		action: { type: 'send', data: '\x1bp' },
		section: 'Claude',
	},
	{
		id: 'pi-queue',
		label: 'Queue',
		description: 'Pi: queue follow-up (Alt+Enter)',
		action: { type: 'send', data: '\x1b\r' },
		section: 'Pi',
	},
	{
		id: 'pi-think',
		label: 'Think',
		description: 'Pi: cycle thinking level (Shift+Tab)',
		action: { type: 'send', data: '\x1b[Z' },
		section: 'Pi',
	},
	{
		id: 'pi-model',
		label: 'Model',
		description: 'Pi: cycle models (Ctrl+P)',
		action: { type: 'send', data: '\x10' },
		section: 'Pi',
	},
	{
		id: 'pi-expand',
		label: 'Expand',
		description: 'Pi: toggle tool output (Ctrl+O)',
		action: { type: 'send', data: '\x0f' },
		section: 'Pi',
	},
	{
