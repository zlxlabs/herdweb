...
export default {
  ...
  drawer: {
    buttons: [
      { id: 'agent-reply', label: 'Reply', description: 'Codex: answer pending question (Alt+↑)', action: { type: 'send', data: '\x1b[1;3A' }, section: 'Agent' },
      { id: 'agent-slash', label: '/', description: 'Open slash commands', action: { type: 'send', data: '/' }, section: 'Agent' },
      { id: 'agent-skill', label: '$', description: 'Codex: invoke a skill', action: { type: 'send', data: '$' }, section: 'Agent' },
